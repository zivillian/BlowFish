...
namespace Elskom.Generic.Libs
{
    ...
    public sealed class BlowFish : IDisposable
    {
        ...
        /// <returns>Plaintext.</returns>
        public byte[] Decrypt_CBC(byte[] ct) => this.Crypt_CBC(ct, true);
        ...
        public byte[] Encrypt_CBC(byte[] pt) => this.Crypt_CBC(pt, false);
        ...
        public byte[] Encrypt_ECB(byte[] pt) => this.Crypt_ECB(pt, false);
        ...
        {
            this.bfP = this.SetupP();

            // set up the S blocks
            this.bfS0 = this.SetupS0();
            this.bfS1 = this.SetupS1();
            this.bfS2 = this.SetupS2();
            this.bfS3 = this.SetupS3();
        ...
        {
            var x1 = (this.bfS0[this.WordByte0(b)] + this.bfS1[this.WordByte1(b)]) ^ this.bfS2[this.WordByte2(b)];
            var x2 = x1 + this.bfS3[this.WordByte3(b)];
